  ...
  return (
    <section className="bg-white py-[120px]">
      <div className="mx-auto max-w-7xl px-6 md:px-20">
        <motion.h2
          className="font-serif text-[48px] font-semibold leading-tight text-navy"
        ...
        <div className="mt-16 grid grid-cols-2 gap-6 lg:grid-cols-4">
          {clientLogos.map(({ src, href }, index) => {
            ...
            return (
              <motion.div
                key={src}
                className="group relative flex items-center justify-center overflow-hidden rounded border bg-white p-10 transition-shadow duration-200 hover:shadow-md"
              ...
              >
                ...
                >
                  <img
                    src={src}
                    alt=""
                    className="h-[90px] w-full object-contain opacity-100 transition-opacity duration-500 ease-[ease] group-hover:opacity-0"
                  />
                </a>
                <img
                  src={hoverSrc}
